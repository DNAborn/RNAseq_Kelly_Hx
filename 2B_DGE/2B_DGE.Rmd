...
subset(results_list[["Nx.Hif1b.vs.Kelly"]],symbol="FABP5P7")

results_list[["Nx.Hif1b.vs.Kelly"]][results_list[["Nx.Hif1b.vs.Kelly"]]$symbol=="FABP5P7",]
...
## Overlaps (Venn)
### - Hif1a
```{r venn_hif1a, include=TRUE, echo=FALSE, eval=TRUE,fig.show="hold", out.width="100%", fig.height=5}
...
plotCounts(dds, gene="ENSG00000073060")
...
pie(mcols(dds)[top_hif1a %>% rownames(),"colors"] %>% .[!is.na(.)] %>% summary(),col=mcols(dds)[top_hif1a %>% rownames(),"colors"] %>% summary() %>% names(), main="Correlation with WGCNA")
...
### - other
```{r venn_other, eval=FALSE, echo=FALSE}
...
## Volcanos
### Draw Vulcanos
```{r draw vulcano,  echo=FALSE, fig.show="hold", fig.height=4}
