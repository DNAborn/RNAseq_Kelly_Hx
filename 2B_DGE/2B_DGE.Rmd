...
r1$symbol <- mcols(dds)$symbol
res.Hx.vs.Nx.Hif1a.vs.Kelly <- r1
n<- "Hx.vs.Nx.Hif1a.vs.Kelly"
assign(paste("res",n,sep="."),r1)
results_list[[n]] <- r1
...
r1$symbol <- mcols(dds)$symbol
res.Hx.vs.Nx.Hif2a.vs.Kelly <- r1
n<- "Hx.vs.Nx.Hif2a.vs.Kelly"
assign(paste("res",n,sep="."),r1)
results_list[[n]] <- r1
...
r1$symbol <- mcols(dds)$symbol
res.Hx.vs.Nx.Hif1b.vs.Kelly <- r1
n<- "Hx.vs.Nx.Hif1b.vs.Kelly"
assign(paste("res",n,sep="."),r1)
results_list[[n]] <- r1
...
## Overlaps (Venn)
```{r venn,fig.show="hold", out.width="80%", fig.with="50%",fig.height=4}
