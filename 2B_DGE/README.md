...
- [2. Data Dive](#2-data-dive)
  - [Volcanos](#volcanos)
    ...
    - [Vulcano function](#vulcano-function)
...
``` r
ev_kelly <- eVukcano_SK(n="Kelly.Hx.vs.Nx",
            ntop=200,
            topcol="royalblue4",
            hscol="royalblue1",
            lcol="grey20")
...
![](Readme_files/figure-gfm/draw%20vulcano-1.png)<!-- -->

``` r
( ev_hif1a + ev_hif2a)
```

![](Readme_files/figure-gfm/draw%20vulcano-2.png)<!-- -->
