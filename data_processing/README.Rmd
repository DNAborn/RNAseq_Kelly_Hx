...
## - Tximeta
```{r tximeta, fig.height=12, eval=FALSE}
...
## - DESeq2
```{r deseq2, warning=FALSE, eval=FALSE}
...
```{r pca, warning = FALSE, fig.show="hold", out.width="100%", fig.height=8}
# transform data
load(file=paste(data,"deseq2.dds", sep="/"))
...
###### -- Advanced PCA
```{r pca_advanced, warning = FALSE, fig.show="hold", out.width="100%", fig.height=8}
# transform data
...
###### -- PCA gif
```{r pca_gif, eval=FALSE, warning = FALSE, fig.show="hold", out.width="100%", fig.height=8}
