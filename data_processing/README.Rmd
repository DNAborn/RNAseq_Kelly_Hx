...
pcaData <- plotPCA(vsd, intgroup=c("genotype", "treatment","exp_rep","condition","clone"), returnData=TRUE)
percentVar <- round(100 * attr(pcaData, "percentVar"))
ggplot(pcaData, aes(PC1, PC2, color=clone, shape=treatment)) +
  geom_point(size=3) +
