...
## - #Tximeta
```{r tximeta, fig.height=12, eval=TRUE}
...
## - #DESeq2
```{r deseq2, warning=FALSE, eval=TRUE}
...
```{r pre_sample_dist, fig.height=6, out.width="100%"}
...
```{r pca, warning = FALSE, fig.show="hold", out.width="80%", fig.height=7}
# transform data
load(file=paste(data,"deseq2.dds", sep="/"))
...
###### -- Advanced PCA
```{r pca_advanced, warning = FALSE, fig.show="hold", out.width="80%", fig.height=6}
# transform data
...
###### -- #PCA gif
```{r pca_gif, eval=TRUE, warning = FALSE, fig.show="hold", out.width="100%", fig.height=8}
...
}, interval = 0.5, movie.name = '1_data_processing/pca.gif', ani.width = 600, ani.height = 600)

#
```

[PCA Gif](1_data_processing/pca.gif){height=100%, width=100%}

```{r pca_gif_include, out.width="100%", fig.height=8}
...
### - Plot example counts
```{r example_counts, eval=TRUE, fig.show="hold", out.width="50%"}
# CA9 & EPO
load(file=paste(data,"deseq2.dds", sep="/"))
goi <- c("CA9","EPO")
