...
lnames = load(file = "WGCNA/data/FemaleLiver-01-dataInput.RData");
...
save(consMEs, moduleColors, moduleLabels, consTree, file = "WGCNA/data/Consensus-NetworkConstruction-man.RData")
