...
## Cluster Holger
```{r cluster_holger, fig.width=10, fig.height=4, dpi=300}
...
## GO Analysis
```{r, fig.height=15, fig.width=10, out.width="50%", fig.show='hold'}
...
## Cluster GO terms
```{r go_cluster, fig.height=12.5, fig.width=8.2, fig.show='hold'}
...
## KEGG
```{r, fig.height=8, fig.width=6, out.width="50%"}
